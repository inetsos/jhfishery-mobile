...
var InvoiceUnstoringComponent = /** @class */ (function () {
    function InvoiceUnstoringComponent(route, router, authService, invoiceService, utilService, formBuilder, unstoringService) {
        ...
        this.theForm = formBuilder.group({
            ...
            'outSum': [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern(/^[0-9]*$/)]],
    ...
    InvoiceUnstoringComponent.prototype.onFormSubmit = function (form) {
        ...
        this.unstoringService.create(form.value)
            .then(function (data) {
            _this.invoice.unstoring.push(data._id);
            _this.invoiceService.update(_this.id, _this.invoice)
                .then(function (data) {
